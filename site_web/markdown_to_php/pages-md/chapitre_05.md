...
La structure de contrôletant queest modélisée sur la Figure. Elle est
...
int =0;
switch(c)
case'a':case'A':code=1;break;
case'b':case'B':code=2;break;
...
case'z':case'Z':code=26;break;
}
return ;
10}
12int (char )
...
```text
default:liste_instructions_defaut;
6}
```
...
```nasm
mov ,N ; edx = 1003 = 000..0011_1110_1011_b
and ,7 ; ~7 & 111..1111_1111_1000_b
; edx = 1000 = 11_1110_1000_b
```
...
```text
for(int =0;ii<std::min(i+BLOCK_SIZE,N); ii)
A[ii] 0;
}
7}
```
...
xor ,eax ; valeur de sortie à 0
cmp ,0 ; ou test edx, edx
setnz
; sortie de la fonction
```
