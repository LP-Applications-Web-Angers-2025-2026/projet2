...
// retravailler
        echo "<pre>";
        foreach ( $resultat2 as $ligne => $lignes){
            echo $lignes;
            echo "<br>";
        }
        echo "</pre>";
    ...
    <ul>
        ...
        <li> Enfin la troisième fonction utilise un tableau afin d’éviter les branchements conditionnels induits par le if ou le switch.
            La fonction réalisée avec un if est présentée Listing 15.2.1.    </li>
        <li> Les fonctions auront toutes la même signature à savoir un pointeur sur une chaine de caractères en C,
            la longueur de la chaine et un pointeur sur un tableau de six entiers qui sont les
            compteurs du nombre d’occurrences de chaque voyelle.  </li>
    </ul>
...
<div id="graph_container" style="width:100%; height:600px;">
    <div id="graph_ancien"></div>
    <div id="graph_moderne"></div>
    <div id="graph_recent"></div>
</div>
