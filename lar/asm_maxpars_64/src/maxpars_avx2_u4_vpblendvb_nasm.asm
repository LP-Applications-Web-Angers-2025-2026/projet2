...
global maxpars_avx2_u4_vpblendvb
...
.for_u128:
	...
	; ---------------------------------------------
	; next 32
	vmovdqa		ymm1, [rdi + r9 + 32]	
	vmovdqa		ymm2, [rsi + r9 + 32]   
	...
	add			eax, r8d
	vpblendvb	ymm3, ymm4, ymm5  
	vmovdqa		[rdx + r9 + 32], ymm3 	; put result in z
	
	; ---------------------------------------------
	; next 32
	vmovdqa		ymm1, [rdi + r9 + 64]	
	vmovdqa		ymm2, [rsi + r9 + 64]   
	vpand		ymm3, ymm1, ymm2    
	vpor		ymm4, ymm1, ymm2    
	vpcmpeqb 	ymm5, ymm0, ymm3    
	vpmovmskb 	r8d, ymm5		
	...
	add			eax, r8d
	vpblendvb	ymm3, ymm4, ymm5  
	vmovdqa		[rdx + r9 + 64], ymm3 	; put result in z
