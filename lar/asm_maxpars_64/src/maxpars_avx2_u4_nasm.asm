...
.for_u128:
	...
	; third 32
	vmovdqa		ymm1, [rdi + r9 + 64]	; ymm1 <- x[i:i+15]
	vmovdqa		ymm2, [rsi + r9 + 64]    ; ymm2 <- y[i:i+15]
	...
	vpandn		ymm2, ymm5, ymm3  
	vpor		ymm1, ymm2
	vmovdqa		[rdx + r9 + 64], ymm1 	; put result in z

	; fourth 32
	vmovdqa		ymm1, [rdi + r9 + 96]	; ymm1 <- x[i:i+15]
	vmovdqa		ymm2, [rsi + r9 + 96]    ; ymm2 <- y[i:i+15]
	...
	vpandn		ymm2, ymm5, ymm3  
	vpor		ymm1, ymm2
	vmovdqa		[rdx + r9 + 96], ymm1 	; put result in z	
