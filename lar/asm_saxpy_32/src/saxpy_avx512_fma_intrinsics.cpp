...
f32 saxpy_avx512_fma_intrinsics(f32 * restrict x, f32 * restrict y, f32 a, u32 size) {
#else
f32 saxpy_avx512_fma_intrinsics(f32 * __restrict__ x, f32 * __restrict__ y, f32 a, u32 size) {
#endif
	...
	__m512 _x, _y, _a, _sum __attribute__((aligned(CPU_MEMORY_ALIGNMENT)));
