...
%endif	
	...
	; !!!!! NOTE !!!!!
	; use "mov edx, pshufd_label_text" if you enabled
	; text section as writable and used
	; #define TEXT_WRITABLE
	; in vec_merge_sort.cpp file
	; otherwise use this:
	...
	; !!!!! NOTE !!!!!
	; remove this instruction is you use TEXT_WRITABLE
