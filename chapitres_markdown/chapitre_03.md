# Chapitre 3 : LeFonctionnementdu Microprocesseur
...
et 4 Go =2
32. Pour accéder à l’adresse197_632 = 3×65_536 + 1024 , il nous faut
...
8. Cette technologie est appeléePrecision Boost2 chez AMD.
9. On parle également parfois deThermal Dissipation Power.
...
prendre en compte la génération du microprocesseur (cf. Table).
Il est préférable de consulter la base de données des microprocesseurs Intel
afin d’obtenir des informations adéquates.
. Un chipset est un ensemble de composants électroniques qui permet la communication entre
...
Année Etape ArchitectureGénérationFinesse
...
TABLE3.5 – Nom des architectures Intel en fonction des années
...
16...
#### 3.9.1.2 Pour utiliserlstopoil faut installer le paquethwlocsous Ubuntu :
...
### 3.10.3 Geekbench est une suite de test disponible pour Windows, Linux et MacOS qui
