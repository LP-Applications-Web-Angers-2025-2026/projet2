...
### 1.1.1 Fonction bsr, version 1

### 1.1.2 Fonction bsr, version 3

### 1.3.1 Fonction nombre premier, version inefficace

### 1.3.2 Fonction nombre premier, version améliorée

### 1.3.3 Fonction nombre premier, version optimisée

### 1.3.4 Nombre premier avec crible

### 1.3.5 Tri à bulles en ordre croissant

### 1.3.6 Recherche de doublons, version simpliste

### 2.4.1 Précision et nombres flottants

### 2.5.1 Convertir une chaine en majuscules

### 4.3.1 Hello world en nasm

### 4.4.1 Exemple de traduction

### 5.4.1 Si Alors avec conjonction de conditions

### 5.4.2 Si Alors avec conjonction de conditions

### 5.4.3 Tant que

5.4.4 Equivalence des bouclespourettant que. . . . . . . . . . . . . .

### 5.4.5 Traduction améliorée du for

### 5.4.6 Exemple de switch simplifiable par une expression

### 5.4.7 Exemple de switch avec table de conversion

### 5.4.8 Exemple de switch avec table de conversion en assembleur 32 bits

### 5.4.9 Dépliage de boucle

5.4.10Dépliage de boucle avec macro instruction

### 6.2.1 Appelant en 32 bits

2 CODES SOURCES

### 6.2.2 Appelé en 32 bits

### 6.3.1 Traduction en 64 bits de la fonction sum

### 6.3.2 Traduction en 64 bits de la fonction sum - version améliorée

### 11.3.1 Produit de matrice, fonction de référence

### 11.6.1 Produit de matrice, Inversion de boucles j et k

### 11.8.1 Produit de matrice - Tuilage 4x4

### 11.8.2 Produit de matrice - Tuilage

### 13.2.1 SAXPY modifiée - fonction de référence

### 13.3.1 SAXPY modifiée - implantation FPU

### 13.4.1 SAXPY modifiée - fonction de référence dépliée par 4

### 13.4.2 Macro instruction nasm

### 13.4.3 SAXPY modifiée - implantation partielle avec FPU et dépliage par 4344

### 13.5.1 SAXPY version SSE

### 13.7.1 SAXPY version FMA

### 14.2.1 Maximum de Parcimonie fonction de référence en C

### 14.3.1 Maximum de Parcimonie fonction de référence en assembleur

### 14.4.1 Maximum de Parcimonie fonction de référence sans if

### 14.5.1 Maximum de Parcimonie fonction de référence sans if optimisée

### 14.6.1 Maximum de Parcimonie version SSE2

### 14.7.1 Maximum de Parcimonie version SSE4.1

### 14.8.1 Maximum de Parcimonie version AVX2

### 15.2.1 Compter les voyelles avec un if

### 15.2.2 Compter les voyelles avec un switch

### 15.2.3 Compter les voyelles avec un tableau

### 16.2.1 Fibonacci - fonction récursive

### 16.2.2 Fibonacci - fonction récursive améliorée

### 16.4.1 Fibonacci - fonction de référence

### 16.5.1 Fibonacci - fonction de référence en assembleur

### 16.6.1 Fibonacci - fonction itérative avec tableau

### 16.7.1 Fibonacci - fonction itérative avec boucle while

CODES SOURCES 3

### 16.7.2 Fibonacci - fonction itérative avec while en assembleur

### 16.7.3 Fibonacci - fonction itérative avec while et amélioration du dépliage404

### 16.8.1 Fibonacci - fonction itérative vectorielle

### 16.8.2 Fibonacci - fonction vectorielle SSE

### 16.8.3 Fibonacci - fonction vectorielle AVX

### 16.9.1 Fibonacci - fonction la plus performante

### 17.2.1 Nombre auto-descriptif, fonction de référence

### 17.4.1 Nombre auto-descriptif, fonction de conversion en chiffres

### 17.5.1 Fonction assembleur - version 1 - début

### 17.5.2 Fonction assembleur - version 1 - conversion

### 17.5.3 Fonction assembleur - version 1 - comparaison et sortie
...
### 17.5.6 BCD - version 1 - Détermination de la longueur du nombre

### 17.5.7 BCD - version 1 - Conversion du nombre

### 17.5.8 BCD - version 1 - Macros instructions pour la conversion

### 17.5.9 BCD - version 1 - Comparaison du nombre d’occurrences des

chiffres avec le nombre

### 17.5.10 BCD - version 2 - Conversion

### 17.5.11 BCD - version 2 - Trouver la longueur du nombre

### 17.5.12 Division par 10000 - Conversion

B.1.1 Programme comportant quelques bogues
4 CODES SOURCES
Tabledesmatières
1.1
1.1.1
...
tran ou des langages objet commeC
++. Les notions liées à l’assembleur permettent
...
d’exemplaires à travers le monde. Cemonstre de puissanceétait affublé d’un micro-
...
du C64 était sobre. Notamment, il ne disposait pas d’instruction de typeclrscr
ouclearscreenchargée d’effacer l’écran. Il fallait utiliser l’instruction PRINT avec
...
Je suis également redevable de mon engouement pour l’assembleur àBenoît
Micheldont le "Livre du 64" [21] fut le livre de chevet de mon adolescence. On
...
système d’exploitation commemakepour la compilation automatique,g
++pour
le compilateurC
++etnasmen ce qui concerne la partie assembleur. Linux, de
...
chapitres introduisent les notions fondamentales (Chapitres) et les suivants
se révèlent plus pratiques.
Lechapitre traite de notions générales et fondamentales en informatique et
FIGURE1 – Le Livre du C64
aborde succintement des notions liées au Génie Logiciel et au travail de l’informati-
cien.
Lechapitre concerne le codage de l’information notamment des nombres
entiers, des réels que l’on qualifie de nombres à virgule flottante et des chaînes de
caractères.
Lechapitre aborde les notions liées à la mémoire (comme l’alignement,
l’adressage mémoire et ledual channel) et les notions relatives au fonctionnement
du microprocesseur (chargement des instructions, décodage et exécution, pipeline,
etc).
Lechapitre traite des logiciels utilisés dans le cadre de cet ouvrage c’est à
dire les éditeurs, l’assembleur, le compilateur et le débogueur.
Lechapitre reprend les notions vues sur les registres dans le chapitre
...
comme leif, lewhile, leforet leswitchen assembleur x86.
Lechapitre apprend comment passer des paramètres à un sous-programme
...
Lechapitre aborde le traitement desnombres à virgule flottanteparle coproces-
seur(FPU). On montre comment traduire simplement une expression arithmétique
en utilisant les mnémoniques de la FPU.
Lechapitre traite des unités vectorielles et des instructions liées à ces unités
que sont leSSE, l’AVXet l’AVX512. On introduit également lesintrinsicsqui sont des
...
C.
Le dernier chapitre académique (chapitre ) traite de l’algèbre de Boole. Même
...
Plusieurs études de cas (chapitres) permettent de mettre en oeuvre
...
en assembleur.
Lechapitre aborde l’optimisation du produit de deux matrices carrées
d’entiers. On montre en particulier l’importance de l’accès mémoire et de la mémoire
cache.
Lechapitre se focalise sur l’implantation de l’instructionpopcntqui compte
...
Lechapitre traite de l’implantation de la fonction saxpy et permet d’intro-
...
Lechapitre aborde des notions liées à la bioinformatique. On montre
...
Lechapitre se focalise sur la programmation en architecture 64 bits et
...
Lechapitre sintéresse à l’implantation d’une fonction qui calcule le n-ème
...
nombre d’or.
Enfin, le dernier chapitre des études de cas
...
la division par un invariant par une multiplication, comme évoqué section.
...
•
une mini étude de cas concernant l’utilisation de l’instruction assembleurbsr
•
